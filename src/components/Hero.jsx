...
export default function Hero() {
    ...
    useEffect(() => {
        ...
        // Helper: Create dynamic placeholder texture
        ...
        const topTexture = createPlaceholderTexture(512, 512, "#0000ff"); // Blue placeholder
        const bottomTexture = createPlaceholderTexture(512, 512, "#ff0000"); // Red placeholder
        ...
        function loadImage(url, targetTexture, textureSizeVector) {
            ...
            img.onload = function () {
                ...
                const newTexture = new THREE.Texture(canvasEl);
                newTexture.minFilter = THREE.LinearFilter;
                newTexture.magFilter = THREE.LinearFilter;
                newTexture.needsUpdate = true; // ensure GPU updates with the new image

                // Assign the new texture to the correct display uniform
                ...
                if (targetTexture) {
                    try { targetTexture.image = canvasEl; targetTexture.needsUpdate = true; } catch (e) { }
                }
        ...
        return () => {
            ...
            pingPongTarget[0].dispose();
            pingPongTarget[1].dispose();
            topTexture.dispose();
